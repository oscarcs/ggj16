...
class DefaultAssetLibrary extends AssetLibrary {
	...
	public function new () {
		...
		className.set ("assets/dude.png", __ASSET__assets_dude_png);
		type.set ("assets/dude.png", AssetType.IMAGE);
		...
		type.set ("assets/sky.png", AssetType.IMAGE);
		className.set ("assets/tilemaps/tm_0.txt", __ASSET__assets_tilemaps_tm_0_txt);
		type.set ("assets/tilemaps/tm_0.txt", AssetType.TEXT);
		className.set ("assets/tilemaps/tm_1.txt", __ASSET__assets_tilemaps_tm_1_txt);
		type.set ("assets/tilemaps/tm_1.txt", AssetType.TEXT);
		...
		type.set (id, AssetType.IMAGE);
		id = "assets/tilemaps/tm_0.txt";
		path.set (id, id);
		
		type.set (id, AssetType.TEXT);
		id = "assets/tilemaps/tm_1.txt";
		path.set (id, id);
...
@:keep @:bind #if display private #end class __ASSET__assets_dude_png extends flash.display.BitmapData { public function new () { super (0, 0, true, 0); } }
...
@:keep @:bind #if display private #end class __ASSET__assets_tilemaps_tm_0_txt extends null { }
@:keep @:bind #if display private #end class __ASSET__assets_tilemaps_tm_1_txt extends null { }
...
@:image("assets/dude.png") #if display private #end class __ASSET__assets_dude_png extends lime.graphics.Image {}
...
@:file("assets/tilemaps/tm_0.txt") #if display private #end class __ASSET__assets_tilemaps_tm_0_txt extends lime.utils.Bytes {}
@:file("assets/tilemaps/tm_1.txt") #if display private #end class __ASSET__assets_tilemaps_tm_1_txt extends lime.utils.Bytes {}
@:image("assets/tiles.png") #if display private #end class __ASSET__assets_tiles_png extends lime.graphics.Image {}
@:file("C:/Development/Haxe/haxe/lib/flixel/3,3,12/assets/sounds/beep.mp3") #if display private #end class __ASSET__assets_sounds_beep_mp3 extends lime.utils.Bytes {}
@:file("C:/Development/Haxe/haxe/lib/flixel/3,3,12/assets/sounds/flixel.mp3") #if display private #end class __ASSET__assets_sounds_flixel_mp3 extends lime.utils.Bytes {}
@:file("C:/Development/Haxe/haxe/lib/flixel/3,3,12/assets/sounds/beep.ogg") #if display private #end class __ASSET__assets_sounds_beep_ogg extends lime.utils.Bytes {}
@:file("C:/Development/Haxe/haxe/lib/flixel/3,3,12/assets/sounds/flixel.ogg") #if display private #end class __ASSET__assets_sounds_flixel_ogg extends lime.utils.Bytes {}
@:font("C:/Development/Haxe/haxe/lib/flixel/3,3,12/assets/fonts/nokiafc22.ttf") #if display private #end class __ASSET__assets_fonts_nokiafc22_ttf extends lime.text.Font {}
@:font("C:/Development/Haxe/haxe/lib/flixel/3,3,12/assets/fonts/arial.ttf") #if display private #end class __ASSET__assets_fonts_arial_ttf extends lime.text.Font {}
