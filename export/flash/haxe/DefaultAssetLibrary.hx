...
@:keep @:bind #if display private #end class __ASSET__assets_tilemaps_tm_0_txt extends flash.utils.ByteArray { }
@:keep @:bind #if display private #end class __ASSET__assets_tilemaps_tm_1_txt extends flash.utils.ByteArray { }
